...
type Notification struct {
	...
	BizId Business               `protobuf:"varint,1,opt,name=biz_id,json=bizId,proto3,enum=notification.v1.Business" json:"biz_id,omitempty"`
	// 业务方某个业务内部的唯一标识
...
const file_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"\"notification/v1/notification.proto\x12\x0fnotification.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xaf\x02\n" +
	"\fNotification\x120\n" +
	"\x06biz_id\x18\x01 \x01(\x0e2\x19.notification.v1.BusinessR\x05bizId\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x1c\n" +
	"\treceivers\x18\x03 \x03(\tR\treceivers\x122\n" +
	...
	"\x0ftemplate_params\x18\a \x01(\v2\x17.google.protobuf.StructR\x0etemplateParams\"\\\n" +
	...
	"\x10SendNotification\x12(.notification.v1.SendNotificationRequest\x1a).notification.v1.SendNotificationResponseB\xcd\x01\n" +
	"\x13com.notification.v1B\x11NotificationProtoP\x01ZFgithub.com/Duke1616/ecmdb/api/proto/gen/notification/v1;notificationv1\xa2\x02\x03NXX\xaa\x02\x0fNotification.V1\xca\x02\x0fNotification\\V1\xe2\x02\x1bNotification\\V1\\GPBMetadata\xea\x02\x10Notification::V1b\x06proto3"
...
var file_notification_v1_notification_proto_goTypes = []any{
	(Business)(0),                          // 0: notification.v1.Business
	(Channel)(0),                           // 1: notification.v1.Channel
	(SendStatus)(0),                        // 2: notification.v1.SendStatus
	(ErrorCode)(0),                         // 3: notification.v1.ErrorCode
	...
	(*BatchSendNotificationsRequest)(nil),  // 7: notification.v1.BatchSendNotificationsRequest
	(*BatchSendNotificationsResponse)(nil), // 8: notification.v1.BatchSendNotificationsResponse
	(*structpb.Struct)(nil),                // 9: google.protobuf.Struct
}
var file_notification_v1_notification_proto_depIdxs = []int32{
	0, // 0: notification.v1.Notification.biz_id:type_name -> notification.v1.Business
	1, // 1: notification.v1.Notification.channel:type_name -> notification.v1.Channel
	9, // 2: notification.v1.Notification.template_params:type_name -> google.protobuf.Struct
	4, // 3: notification.v1.SendNotificationRequest.notification:type_name -> notification.v1.Notification
	2, // 4: notification.v1.SendNotificationResponse.status:type_name -> notification.v1.SendStatus
	3, // 5: notification.v1.SendNotificationResponse.error_code:type_name -> notification.v1.ErrorCode
	4, // 6: notification.v1.BatchSendNotificationsRequest.notifications:type_name -> notification.v1.Notification
	6, // 7: notification.v1.BatchSendNotificationsResponse.results:type_name -> notification.v1.SendNotificationResponse
	5, // 8: notification.v1.NotificationService.SendNotification:input_type -> notification.v1.SendNotificationRequest
	6, // 9: notification.v1.NotificationService.SendNotification:output_type -> notification.v1.SendNotificationResponse
