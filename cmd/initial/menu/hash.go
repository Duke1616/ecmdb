...
// MenuHashCalculator 菜单哈希计算器
type MenuHashCalculator struct {
	logger elog.Component
}

// NewMenuHashCalculator 创建菜单哈希计算器
func NewMenuHashCalculator() *MenuHashCalculator {
	return &MenuHashCalculator{
...
func (m *MenuHashCalculator) CalculateMenuHash() (string, error) {
	// 获取菜单数据
...
// 基于菜单内容而不是文件内容
func (m *MenuHashCalculator) CalculateMenuDataHash(menus interface{}) (string, error) {
	// 将菜单数据序列化为字符串
...
func (m *MenuHashCalculator) serializeMenuData(menus interface{}) (string, error) {
...
func (m *MenuHashCalculator) CalculateProjectMenuHash() (string, error) {
