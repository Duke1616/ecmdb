...
type Service interface {
	...
	FindByUid(ctx context.Context, identifier string, secret string) (domain.Codebook, error)
}
...
func (s *service) FindByUid(ctx context.Context, identifier string, secret string) (domain.Codebook, error) {
	return s.repo.FindBySecret(ctx, identifier, secret)
}
