...
//
//	mockgen -package=repositorymocks -destination=internal/mocks/repositorymocks/resource.mock.go github.com/Duke1616/ecmdb/internal/repository ResourceRepository
//
