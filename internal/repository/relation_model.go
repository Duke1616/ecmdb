...
func NewRelationModelRepository(dao dao.RelationModelDAO) RelationModelRepository {
	return &modelRelationRepository{
		dao: dao,
	}
}

type modelRelationRepository struct {
...
func (r *modelRelationRepository) CreateModelRelation(ctx context.Context, req domain.ModelRelation) (int64, error) {
...
func (r *modelRelationRepository) TotalByModelUid(ctx context.Context, modelUid string) (int64, error) {
...
func (r *modelRelationRepository) DeleteModelRelation(ctx context.Context, id int64) (int64, error) {
	return r.dao.DeleteModelRelation(ctx, id)
}

func (r *modelRelationRepository) toEntity(req domain.ModelRelation) dao.ModelRelation {
...
func (r *modelRelationRepository) toDiagram(src dao.ModelRelation) domain.ModelDiagram {
...
func (r *modelRelationRepository) toDomain(modelDao dao.ModelRelation) domain.ModelRelation {
...
func (r *modelRelationRepository) CountByRelationTypeUID(ctx context.Context, uid string) (int64, error) {
	return r.dao.CountByRelationTypeUid(ctx, uid)
}

func (r *modelRelationRepository) GetByID(ctx context.Context, id int64) (domain.ModelRelation, error) {
	val, err := r.dao.GetByID(ctx, id)
	return r.toDomain(val), err
}

func (r *modelRelationRepository) UpdateModelRelation(ctx context.Context, req domain.ModelRelation) (int64, error) {
