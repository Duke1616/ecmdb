...
func InitModule(db *mongox.DB, attributeModule *attribute.Module, relationModule *relation.Module, q mq.MQ, crypto *cryptox.CryptoRegistry) (*Module, error) {
	...
	fieldDeleteConsumer := initDeleteConsumer(q, service)
	module := &Module{
		Svc:            service,
		EncryptedSvc:   encryptedSvc,
		Hdl:            handler,
		c:              fieldSecureAttrChangeConsumer,
		deleteConsumer: fieldDeleteConsumer,
	}
	return module, nil
}
