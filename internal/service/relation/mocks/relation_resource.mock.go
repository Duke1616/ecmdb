...
//
//	mockgen -source=./resource.go -destination=./mocks/relation_resource.mock.go -package=relationmocks -typed RelationResourceService
//
...
func (m *MockRelationResourceService) DeleteByResourceId(ctx context.Context, resourceId int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteByResourceId", ctx, resourceId)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRelationResourceServiceMockRecorder) DeleteByResourceId(ctx, resourceId any) *MockRelationResourceServiceDeleteByResourceIdCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteByResourceId", reflect.TypeOf((*MockRelationResourceService)(nil).DeleteByResourceId), ctx, resourceId)
	return &MockRelationResourceServiceDeleteByResourceIdCall{Call: call}
}

// MockRelationResourceServiceDeleteByResourceIdCall wrap *gomock.Call
type MockRelationResourceServiceDeleteByResourceIdCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationResourceServiceDeleteByResourceIdCall) Return(arg0 int64, arg1 error) *MockRelationResourceServiceDeleteByResourceIdCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationResourceServiceDeleteByResourceIdCall) Do(f func(context.Context, int64) (int64, error)) *MockRelationResourceServiceDeleteByResourceIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationResourceServiceDeleteByResourceIdCall) DoAndReturn(f func(context.Context, int64) (int64, error)) *MockRelationResourceServiceDeleteByResourceIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// GetCanBeRelatedContext mocks base method.
func (m *MockRelationResourceService) GetCanBeRelatedContext(ctx context.Context, modelUid, relationName string, resourceId int64) (string, []int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCanBeRelatedContext", ctx, modelUid, relationName, resourceId)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].([]int64)
	ret2, _ := ret[2].(error)
...
// GetCanBeRelatedContext indicates an expected call of GetCanBeRelatedContext.
func (mr *MockRelationResourceServiceMockRecorder) GetCanBeRelatedContext(ctx, modelUid, relationName, resourceId any) *MockRelationResourceServiceGetCanBeRelatedContextCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCanBeRelatedContext", reflect.TypeOf((*MockRelationResourceService)(nil).GetCanBeRelatedContext), ctx, modelUid, relationName, resourceId)
	return &MockRelationResourceServiceGetCanBeRelatedContextCall{Call: call}
}

// MockRelationResourceServiceGetCanBeRelatedContextCall wrap *gomock.Call
type MockRelationResourceServiceGetCanBeRelatedContextCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationResourceServiceGetCanBeRelatedContextCall) Return(arg0 string, arg1 []int64, arg2 error) *MockRelationResourceServiceGetCanBeRelatedContextCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationResourceServiceGetCanBeRelatedContextCall) Do(f func(context.Context, string, string, int64) (string, []int64, error)) *MockRelationResourceServiceGetCanBeRelatedContextCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationResourceServiceGetCanBeRelatedContextCall) DoAndReturn(f func(context.Context, string, string, int64) (string, []int64, error)) *MockRelationResourceServiceGetCanBeRelatedContextCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockresourceNameRepository is a mock of resourceNameRepository interface.
type MockresourceNameRepository struct {
	ctrl     *gomock.Controller
	recorder *MockresourceNameRepositoryMockRecorder
	isgomock struct{}
}

// MockresourceNameRepositoryMockRecorder is the mock recorder for MockresourceNameRepository.
type MockresourceNameRepositoryMockRecorder struct {
	mock *MockresourceNameRepository
}

// NewMockresourceNameRepository creates a new mock instance.
func NewMockresourceNameRepository(ctrl *gomock.Controller) *MockresourceNameRepository {
	mock := &MockresourceNameRepository{ctrl: ctrl}
	mock.recorder = &MockresourceNameRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockresourceNameRepository) EXPECT() *MockresourceNameRepositoryMockRecorder {
	return m.recorder
}

// FindResourceById mocks base method.
func (m *MockresourceNameRepository) FindResourceById(ctx context.Context, fields []string, id int64) (domain.Resource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockresourceNameRepositoryMockRecorder) FindResourceById(ctx, fields, id any) *MockresourceNameRepositoryFindResourceByIdCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindResourceById", reflect.TypeOf((*MockresourceNameRepository)(nil).FindResourceById), ctx, fields, id)
	return &MockresourceNameRepositoryFindResourceByIdCall{Call: call}
}

// MockresourceNameRepositoryFindResourceByIdCall wrap *gomock.Call
type MockresourceNameRepositoryFindResourceByIdCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockresourceNameRepositoryFindResourceByIdCall) Return(arg0 domain.Resource, arg1 error) *MockresourceNameRepositoryFindResourceByIdCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockresourceNameRepositoryFindResourceByIdCall) Do(f func(context.Context, []string, int64) (domain.Resource, error)) *MockresourceNameRepositoryFindResourceByIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockresourceNameRepositoryFindResourceByIdCall) DoAndReturn(f func(context.Context, []string, int64) (domain.Resource, error)) *MockresourceNameRepositoryFindResourceByIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
